...
module top_fpga #(
    ...
    wire exception;
    wire [31:0] pc_out;     // Added wire to safely capture the PC output

    // Safely drive the LEDs using the exposed module port
    ...
    ////////////////////////////////////////////////////////////
    pipe pipe_u (
        .clk                 (slow_clk),  // BUG FIX: Wired to slow_clk
        .reset               (reset),
        .stall               (1'b0),
        .exception           (exception),
        .pc_out              (pc_out),    // TODO
    ...
    data_mem DMEM (
        ...
        // TODOs completed via hierarchical routing
